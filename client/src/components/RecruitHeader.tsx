    ...
    >
      <div className="container flex items-center justify-between h-16 md:h-20">
        ...
        <div className="flex items-center gap-2 md:gap-3">
          ...
          <Link href="/apply" className="no-underline [&>*]:text-white">
            <motion.span
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              ...
              whileTap={{ scale: 0.98 }}
              className="hidden sm:inline-flex items-center gap-2 px-5 py-2.5 text-sm font-medium rounded-full bg-accent text-white hover:bg-accent/90 transition-all duration-200 shadow-sm cursor-pointer"
            >
              Start Application
          ...
          <>
            ...
            >
              <div className="container py-4 space-y-1">
                ...
                <Link href="/apply" onClick={() => setMobileOpen(false)} className="block no-underline [&>*]:text-white">
                  <motion.span
                    initial={{ opacity: 0, x: -12 }}
                    animate={{ opacity: 1, x: 0 }}
                    transition={{ delay: 0.1 }}
                    className="flex items-center justify-center gap-2 py-3 px-4 mt-4 rounded-xl bg-accent text-white font-medium hover:bg-accent/90 transition-colors cursor-pointer"
                  >
                    Start Application
                    <ArrowRight className="w-4 h-4" />
                  </motion.span>
