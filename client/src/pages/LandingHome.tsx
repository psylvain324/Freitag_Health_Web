...
const LOGO_URL = "https://d2xsxph8kpxj0f.cloudfront.net/310519663397693691/joVpfAwXfksykrvCYRdrqC/freitag_logo_hires_1022d117.png";
      ...
      <footer className="bg-navy py-8">
        <div className="container text-center">
          ...
          <p className="text-white/40 text-xs mt-2">
            Tampa, FL &middot; 727-249-3807 &middot; ssfreitaginsurance@gmail.com
          </p>
        </div>
      </footer>
    </div>
